...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылка, СтруктураДополнительныеСвойства) Экспорт
	...
	Если Ложь 
		тогда
		ДокументСсылка = Документы.уатПлатежноеПоручениеВходящее.СоздатьДокумент();
	КонецЕсли;
	...
	Если ДокументСсылка.Оплачено тогда
		Для каждого ТекСтрока ИЗ ТабДокумента Цикл
			...
			НовСтрока.БанковскийСчетКасса = ДокументСсылка.БанковскийСчет;
			НовСтрока.ВидДенежныхСредств  = Перечисления.ВидыДенежныхСредств.Безналичные;
			НовСтрока.ПриходРасход        = Перечисления.ВидыДвиженийПриходРасход.Приход;
