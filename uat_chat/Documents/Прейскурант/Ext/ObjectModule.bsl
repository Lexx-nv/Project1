...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Движения.уатПрейскурантыТС.Записывать = Истина;
	Движения.уатПрейскурантыТС.Очистить();
	...
	Если ЗначениеЗаполнено(Номенклатура) ТОгда
			...
			Движение = Движения.уатПрейскурантыТС.Добавить();
	...
	ИНаче
		...
		Для Каждого ТекСтрокаУсловия Из Условия Цикл
			...
			Движение.Период = Дата;
			Движение.Контрагент = пКА;
			Движение.КонтрагентГенЗаказчик = КонтрагентГенЗаказчик;
			...
			Движение.ТипТСнаПечать = ТекСтрокаУсловия.ТипТСнаПечать;
			...
			Движение.Лимит = ТекСтрокаУсловия.Лимит;
...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	Мас = Условия.НайтиСтроки(Новый Структура("ЦехКонтрагента",Справочники.Месторождения.ПустаяСсылка()));
	Для каждого Эл из Мас Цикл
		Эл.ЦехКонтрагента = Справочники.ЦехаКонтрагента.ПустаяСсылка();
	КонецЦикла;
