...
Функция СформироватьЗапросПоДаннымДокумента()
	...
	|	ИЗ
	|	Документ.уатУчетФактическихДанныхПоБюджетам.БюджетныеОперации КАК БюджетныеОперацииДокумент
	// Курсы документа 
	|ЛЕВОЕ СОЕДИНЕНИЕ
	|(ВЫБРАТЬ 
	...
	|		ИЗ
	|			Документ.уатУчетФактическихДанныхПоБюджетам.БюджетныеОперации КАК УчетФактическихДанныхПоБюджетамБюджетныеОперации
	|		ГДЕ
	...
	|		ИЗ
	|			Документ.уатУчетФактическихДанныхПоБюджетам.БюджетныеОперации КАК ОперацииДата
	|		ГДЕ
...
Процедура ДвиженияПоРегистрам(Отказ, Заголовок)
	...
	ТабПроводокДокумента.ЗаполнитьЗначения(Новый(Тип("СправочникСсылка.уатСценарииПланирования")),"Сценарий");
