...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Запись = Движения.уатАрхивДанныхРегламентированнойОтчетности.Добавить();
...
Процедура ПриУстановкеНовогоНомера(СтандартнаяОбработка, Префикс)
	...
	Если НЕ ПустаяСтрока(Организация.Префикс) Тогда
		Префикс = Организация.Префикс;
	КонецЕсли;
	
	//уатОбщегоНазначенияТиповые.ДобавитьПрефиксОрганизации(ЭтотОбъект, Префикс);
