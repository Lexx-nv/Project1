...
#Если НаКлиенте Тогда
	НастройкаПроксиСервера = ПолучениеФайловИзИнтернета.ПолучитьНастройкуПроксиСервера();
#Иначе
...
Функция ПолучитьФайлИзИнтернет(знач URL,
	...
	Если Протокол = "ftp" Тогда
		...
		Исключение
			...
			ПолучениеФайловИзИнтернета.ЗаписатьОшибкуВЖурналРегистрации(СообщениеОбОшибке);
