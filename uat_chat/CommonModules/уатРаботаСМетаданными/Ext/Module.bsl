...
//  ДокументСсылка - Ссылка на доумент, для которого необходимо проверить наличие реквизита.
//
// Возвращаемое значение:
//  Истина - нашли реквизит с таким именем, Ложь - не нашли.
//
Функция уатЕстьРеквизитДокумента(ИмяРеквизита, ДокументСсылка) Экспорт
...
// Позволяет определить есть ли в системе справочник "ЕдиницыИзмерения"
//
Функция естьСпрЕдиницыИзмерения() Экспорт
	
	Возврат ЕстьСправочник("ЕдиницыИзмерения");
