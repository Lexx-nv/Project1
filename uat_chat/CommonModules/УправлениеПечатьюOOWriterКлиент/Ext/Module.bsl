...
Функция ИнициализироватьПечатнуюФормуOOWriter() Экспорт
	...
	Исключение
		...
		ВызватьИсключение(НСтр("ru = 'Ошибка при работе с приложением OpenOffice.org Writer. Необходимо проверить правильность установки приложения.'") 
...
// Получает позицию начала области.
//
...
// Получает позицию окончания области.
//
