...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	Для каждого ЗаписьНабора Из ЭтотОбъект Цикл
		...
		Если Не ТребуетсяНормаДругогоГрафика Тогда
			Если ЗаписьНабора.ВидУчетаВремени = Перечисления.уатВидыУчетаВремени.ПоДням Или ЗаписьНабора.ВидУчетаВремени = Перечисления.уатВидыУчетаВремени.ПоЧасам Тогда
	...
	Если ТребуетсяНормаДругогоГрафика Тогда
		...
		Для каждого ЗаписьНабора Из ЭтотОбъект Цикл
			...
			КонецЕсли;
			Если ЗаписьНабора.ВидУчетаВремени = Перечисления.уатВидыУчетаВремени.ПоДням Тогда 
				ЗаписьНабора.ОсновноеЗначениеНорма = НормаДней;
				ЗаписьНабора.ДополнительноеЗначениеНорма = НормаЧасов;
			ИначеЕсли ЗаписьНабора.ВидУчетаВремени = Перечисления.уатВидыУчетаВремени.ПоЧасам Тогда	
