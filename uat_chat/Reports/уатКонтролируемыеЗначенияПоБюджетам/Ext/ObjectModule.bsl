...
Перем мСтруктураНеСохраняемыеВНастройкеРеквизиты Экспорт; // Структура, содержит реквизиты отчета, 
                   //не подлежащие сохранению
...
Процедура СформироватьНастройкиОтчета(МассивОтбора,СтруктураПредставлениеПолей)
	...
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.уатКонтролируемыеЗначенияБюджетов.Обороты(, , День, ) КАК КонтролируемыеЗначенияБюджетовОбороты
