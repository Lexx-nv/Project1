...
Перем мРазмещениеПоложениеВыбранныхПолей Экспорт; // Структура для хранения настроек размещения и положения
                                                  // выбранных полей отчета

Перем мСтруктураПредставлениеПолей Экспорт; // Структура для хранения представлений выводимых в отчет полей
Перем мСоответствиеСвойствКатегорийИИзмерений Экспорт; // Структура для хранения соответствий между свойствами,
                                                       //категориями и измерениями
Перем мСоответствиеКонтактнойИнформацииИИзмерений Экспорт; // Структура для хранения соответствий между измерениями,
                                                           //и контактной информацией
Перем мСоответствиеДанныхОФизлицеИИзмерений Экспорт; // Структура для хранения соответствий между измерениями и,
                                                     //данными о физ. лице
Перем мСоответствиеПолейИИзмерений Экспорт; // Структура для хранения соответствий между измерениями и полями
Перем мСоответствиеНазначений Экспорт; // Структура для хранения соответствий назначений
Перем мСоответствиеСвязьПолей; // Структура для хранения соответствий связи полей
Перем мСоответствиеТиповИнтервальныхПолей Экспорт; // Соответствие для типов полей интервалов

Перем мСтруктураФорматаПолей Экспорт; // структура для хранения форматов выводимых в отчет полей

Перем мСтруктураПериодов Экспорт; // структура для хранения периодов

Перем мТаблицаПолей; // таблица полей
Перем мТаблицаПолейКонтактнаяИнформация; // таблица полей о контактной информации
Перем мТаблицаПолейДанныеОФизлице Экспорт; // таблица полей о данных физ. лица

Перем мНастройкаПериода Экспорт; // настройка периода
Перем мРежимВводаПериода Экспорт; // (-1) - не выбирать период, 0 - произвольный период, 1 - на дату, 
                            //2 - неделя, 3 - декада, 4 - месяц, 5 - квартал, 6 - полугодие, 7 - год
Перем мМинимальнаяШиринаКолонкиПоказатель Экспорт; // минимальное значение ширины колонки показателя (если указана)
Перем мШиринаКолонкиПоказательПоУмолчанию Экспорт; // ширина колонки показателя, если она вообще не указана (равна 0)
Перем мВыбиратьИмяРегистра Экспорт; //разрешать выбор имени регистра
Перем мВыбиратьИспользованиеСвойств Экспорт; //разрешить выбор свойств для вывода в отчет
Перем мРежимФормыНастройкиБезГруппировокКолонок Экспорт; //текущий режим отображения формы настройки
Перем мНазваниеОтчета Экспорт; // название отчета

Перем мСтруктураИзмеренийСтроки; // структура для хранения измерений строки
Перем мСтруктураИзмеренийКолонки; // структура для хранения измерений колонки
Перем мПоляДетали; // структура для хранения детальных полей

Перем мТекущаяНастройка Экспорт; //текущая настройка

Перем мТекущаяСтраницаНастройка Экспорт; // текущая страница формы настроек
Перем мРасширеннаяНастройка Экспорт; // использовать режим расширенной настройки

Перем мВосстанавливатьНастройкиПриОткрытии Экспорт; //восстанавливать настройки при открытии
Перем мРассчитыватьШиринуКолонкиПоНазванию Экспорт; //рассчитывать ширину колонки по названию
Перем мРассчитыватьШиринуКолонок Экспорт; // рассчитывать ширину колонок

Перем мВидПредставленияПолей Экспорт; // текущий вид представления полей отчета

Перем мМассивПоляГруппировка; // массив для хранения полей группировок
Перем мМассивПоляРесурс; // массив для хранения полей ресурсов
Перем мМассивБыстрыеОтборы; // массив для хранения быстрых отборов

Перем мПутьКПостроителюОтчета Экспорт; // путь к построителю отчета
Перем мДействиеПолеВводаВидСравненияПриИзменении Экспорт; // действие, вызываемое при изменении вида сравнения отбора
Перем мДействиеПолеВводаЗначениеПриИзменении Экспорт; // действие, вызываемое при изменении значения отбора
Перем мДействиеКоманднаяПанельФормыПечать Экспорт; // действие, вызываемое при нажатии кнопки печать

Перем мДействиеКоманднаяПанельФормыСправкаФормы Экспорт; // действие, вызываемое при нажатии кнопки справка формы
Перем мДействиеВстроеннаяСправкаonclick Экспорт; // действие, вызываемое при нажатии мыши на кнопку встроенна печать
Перем мДействиеВстроеннаяСправкаonmouseout Экспорт; // действие, вызываемое когда курсор мыши заходит на область кнопки встроенная печать
Перем мДействиеВстроеннаяСправкаonmouseover Экспорт; // действие, вызываемое когда курсор мыши покидает область кнопки встроенная печать 

Перем мИмяЭлементаУправленияПолеТабличногоДокументаРезультат Экспорт; // имя элемента управления в который будет 
                                                                      // выводиться результат запроса
Перем мИмяЭлементаУправленияБыстрыеОтборы Экспорт; // имя элемента управления для настройки быстрых отборов
Перем мИмяЭлементаУправленияДополнительныеЭлементы Экспорт; // имя элемента управления для настройки дополнительных
Перем мИмяЭлементаУправленияСправкаФормы Экспорт; // имя элемента управления для настройки справки формы

Перем мОбработкиПодключаемыеКОтчету; //
Перем мДействиеФормыВыполнитьВнешнююОбработку Экспорт; //

// Процедура выполняет формирование отчета по установленным настройкам
//
// Параметры:
//  ТабличныйДокумент - табличный документ куда будет производиться вывод отчета
//  Очищать      - очищать табличный документ перед выводом отчета
//  ФиксироватьЗаголовок - фиксировать заголовок
//  Отчет        - отчет
//
Процедура СформироватьОтчет(ТабличныйДокумент, Очищать = Истина, ФиксироватьЗаголовок = Истина, Отчет = Неопределено) Экспорт
	...
	Если ЗначениеЗаполнено(ДатаКон) И ДатаНач > ДатаКон Тогда
		Сообщить("Неправильно заполнена дата. Дата начала не может быть больше даты окончания",СтатусСообщения.Важное);
		Возврат;
	КонецЕсли;
	...
	Если ВыводВозможен() Тогда
		...
		ПостроительОтчета.Макет = ПолучитьМакетПостроителяОтчета();
...
// Функция выполняет получения результата запроса
//
...
// Процедура выполняет установку начальных настроек построителя отчета
//
// Параметры:
//  УниверсальныйОтчет - признак того, что используется универсальный отчет
...
// Процедура выполняет переустановку начальных настроек построителя отчета
//
// Параметры:
//  Объект       - отчет
//  Отчет        - отчет
...
Функция ПолучитьМакетПостроителяОтчета()
...
КонецФункции // ПолучитьМакетПостроителяОтчета()
...
Процедура ДобавитьОбластьШапкаТаблицы(Макет)
	...
	Для каждого ТекущийПоказатель из Показатели.Строки Цикл
		...
		Если ТекущийПоказатель.Строки.Количество() > 0 И ТекущийПоказатель.Использование > 0 Тогда
			...
			Для каждого Показатель из ТекущийПоказатель.Строки Цикл
				...
				Если Показатель.Использование > 0 Тогда
					...
					ОбластьПоказатель.ШиринаКолонки = ?(Показатель.Ширина = 0, мШиринаКолонкиПоказательПоУмолчанию, ?(Показатель.Ширина < мМинимальнаяШиринаКолонкиПоказатель, мМинимальнаяШиринаКолонкиПоказатель, Показатель.Ширина));
		...
		ИначеЕсли ТекущийПоказатель.Использование > 0 Тогда // Показатель
			...
			ОбластьПоказатель.ВертикальноеПоложение = ВертикальноеПоложение.Центр;
			ОбластьПоказатель.РазмещениеТекста = ТипРазмещенияТекстаТабличногоДокумента.Переносить;
			ОбластьПоказатель.ШиринаКолонки = ?(ТекущийПоказатель.Ширина = 0, мШиринаКолонкиПоказательПоУмолчанию, ?(ТекущийПоказатель.Ширина < мМинимальнаяШиринаКолонкиПоказатель, мМинимальнаяШиринаКолонкиПоказатель, ТекущийПоказатель.Ширина));
...
// Процедура выполняет установку фиксированных строк в табличном документе
//
// Параметры:
...
// Функция выполняет проверку переданного поля на то что это показатель
// 
// Параметры:
//  ПолеИмя      - Имя проверяемого поля
//
// Возвращаемое значение:
...
// Процедура выполняет добавление в текст запроса раздела для работы с свойствами и категориями
//
// Параметры:
//  ТекстЗапроса - текст запроса
//  ТаблицаПолей - таблица полей запроса
//  СтруктураПредставлениеПолей - структура представления полей запроса
//  СоответствиеНазначений - структура соответствий назначений свойств и категорий
//  Параметры    - Параметры запроса
//  СоответствиеСвойствКатегорийИИзмерений - структура соответствия свойств, категорий и измерений
//  СтруктураЗаменять - заменяемая структура
//
...
// Процедура выполняет добавление в текст запроса раздела для работы с контактной информацией
//
// Параметры:
//  ТекстЗапроса - текст запроса
//  ТаблицаПолей - таблица полей запроса
//  СтруктураПредставлениеПолей - структура представления полей запроса
//  Параметры    - Параметры запроса
//  СоответствиеКонтактнойИнформацииИИзмерений - структура соответствия контактной информации и измерений
//  СтруктураЗаменять - заменяемая структура
//
...
// Процедура выполняет добавление в текст запроса раздел для работы с данными о физ. лице
//
// Параметры:
//  ТекстЗапроса - текст запроса
//  ТаблицаПолей - таблица полей запроса
//  СтруктураПредставлениеПолей - структура представления полей запроса
//  Параметры    - Параметры запроса
//  СоответствиеДанныхОФизлицеИИзмерений - структура соответствия данных о физ. лице и измерений
//  СтруктураЗаменять - заменяемая структура
//
...
// Процедура Устанавливает типы значений свойств для отбора 
//
// Параметры:
//  НастраиваемыйПостроительОтчета - построитель отчета
//  СоответствиеСвойствКатегорийИИзмерений - структура соответствия свойств, категорий и измерений
//  СоответствиеНазначений - структура соответствий назначений свойств и категорий
//  СтруктураПредставлениеПолей - структура представления полей запроса
//
...
// Функция выполняет получение интервального поля
// 
// Параметры:
//  ТаблицаИнтервалов - таблица содержащая интервалы
//  СтруктураПараметры - структура параметров
//  СоответствиеТиповИнтервальныхПолей - структура соответствия типов интервальных полей
//  ПолеИнтервала - поле интервала
//  ИсходноеПоле - исходное поле
//  ТипИсходногоПоля - тип исходного поля
//  СтрокаФорматирования - строка форматирования
//
// Возвращаемое значение:
//  Интервальное поле
...
// Процедура выполняет добавление в текст запроса интервальных группировок
//
// Параметры:
//  ТекстЗапроса - текст запроса
//  ИмяПоляФизЛицо - имя поля, содержащего информацию о физ. лице
//  ТаблицаИнтервалов - таблица интервалов
//  СтруктураПредставлениеПолей - структура представления полей запроса
//  Параметры    - Параметры запроса
//  СоответствиеТиповИнтервальныхПолей - структура соответствия типов интервальных полей
//  СтруктураЗаменять - заменяемая структура
...
// Процедура выполняет установку представления полей в построителе
//
// Параметры:
//  СтруктураПредставлениеПолей - структура представления полей
...
Процедура ПодготовитьСправкуФормы(Объект, Отчет, Форма) Экспорт
	...
	ЦветФонаСправки   = "#ffffff";
	ЦветСсылкиСправки = "#000000";
	
	Форма.ЭлементыФормы.ПанельСправкаФормы.ЦветРамки = Новый Цвет(137, 132, 119);
	Форма.ЭлементыФормы.НадписиЗакрытьСправкуФормы.ЦветФона	= Новый Цвет(255, 255, 255);
	Форма.ЭлементыФормы.НадписиЗакрытьСправкуФормы.ЦветТекста = Новый Цвет(0, 0, 0);
...
// Процедура выполняет расчет ширины колонок в табличном документе
//
// Параметры:
//  ТабличныйДокумент - табличный документ в котором производится расчет колонок
//
		...
		Для ТекущаяСтрока = НачальнаяСтрока По КонечнаяСтрока Цикл
			...
			Для НомерСтрокиТекста = 1 По СтрЧислоСтрок(ТекстЯчейки) Цикл
				...
				Если НЕ мРассчитыватьШиринуКолонкиПоНазванию И ТекущаяСтрока < НачалоДанных И ШиринаТекстаЯчейки > 0 Тогда
					...
					//ШиринаТекстаЯчейки = мШиринаКолонкиПоказательПоУмолчанию;
...
// Процедура выполняет размещение заданного поля
//  
// Параметры:
//  Имя          - имя поля
//  Значение     - значение в которое необходимо разместить поле
//
...
// Процедура выполняет установку положения заданного поля
//  
// Параметры:
//  Имя          - имя поля
//  Значение     - значение установки
//
...
// Процедура выполняет получение размещения заданного поля
//  
// Параметры:
//  Имя          - имя поля
//
...
// Процедура выполняет получение положения заданного поля
//  
// Параметры:
//  Имя          - имя поля
//
...
// Процедура выполняет установку пометок для заданного поля
//  
// Параметры:
//  ТекущаяСтрока - Текущая строка
//
...
// Процедура выполняет установку пометок для подчиненных полей
//  
// Параметры:
//  СтрокаРодитель - Текущая строка
//
...
// Процедура выполняет установку пометок для родителей
//  
// Параметры:
//  Родитель      - Текущая строка
//
...
// Процедура выполняет добавление свойств и категорий для заданного поля
//  
// Параметры:
//  ПутьКДанным  - Путь к данным
//  ИмяИзмерения - Имя измерения
//  Представление - Представление поля
//  Назначение   - назначение категории
//  НетКатегорий - признак отсутствия категории
//  ТаблицаПолей - таблица полей
//
...
// Процедура выполняет добавление контактной информации для заданного поля
//  
// Параметры:
//  ПутьКДанным  - Путь к данным
//  ИмяИзмерения - Имя измерения
//  Представление - Представление поля
//  ВидОбъекта   - вид объекта контактной информации
//  ТипОбъекта   - тип объекта контактной информации
//  ТаблицаПолей - таблица полей
//
...
// Процедура выполняет добавление данных о физ. лице для заданного поля
//  
// Параметры:
//  ПутьКДанным  - Путь к данным
//  ИмяИзмерения - Имя измерения
...
// Процедура выполняет очистку настроек построителя отчета
//
// Параметры:
//  ИзмеренияСтроки - признак того что необходимо очищать измерения строки
//  ИзмеренияКолонки - признак того что необходимо очищать измерения колонки
//  ВыбранныеПоля - признак того что необходимо очищать выбранные поля
//  Порядок      - признак того что необходимо очищать порядок
//
...
// Процедура выполняет добавление измерения строки
//
// Параметры:
//  ПутьКДанным  - Путь к данным
//  ТипИзмерения - тип измерения
//
// Возвращаемое значение:
//  Признак успешности добавления
...
// Процедура выполняет добавление измерения колонки
//
// Параметры:
//  ПутьКДанным  - Путь к данным
//  ТипИзмерения - тип измерения
...
// Процедура выполняет добавление отбора
//
// Параметры:
//  ПутьКДанным  - Путь к данным
//  Использование - использование по умолчанию
//  ВидСравнения - вид сравнения по умолчанию
//  Значение     - значение по умолчанию
//  ЗначениеС    - значениеС по умолчанию
//  ЗначениеПо   - значениеПо по умолчанию
//  ИспользоватьВБыстрыхОтборах - признак использования в быстрых отборах
//
// Возвращаемое значение:
//  Признак успешности добавления
...
// Функция выполняет добавление дополнительного поля
//
// Параметры:
//  ПутьКДанным  - Путь к данным
//  размещение   - размещение дополнительного поля
//  Положение    - положение размещаемого поля
//
// Возвращаемое значение:
//  Признак успешности добавления
...
// Функция выполняет установку порядка
//
// Параметры:
//  ПутьКДанным  - Путь к данным
...
// Функция выполняет добавление показателя
//
// Параметры:
//  ИмяПоля      - имя добавляемого поля
//  ПредставлениеПоля - представление поля
//  ВключенПоУмолчанию - признак включенности по умолчанию
//  ФорматнаяСтрока - форматная строка
//  ИмяГруппы    - имя группы показателей
//  ПредставлениеГруппы -представление группы показателей
//  Ширина       - ширина
//
...
// Функция выполняет добавления поля группировки
//
// Параметры:
//  Имя          - имя группировки
//  Родитель     - родитель
//  ПутьКДанным  - путь к данным
//  Представление - представление группировки
//  Тип          - тип
//  Выражение    - выражение группировки
//
...
// Процедура выполняет добавления поля ресурса
//
// Параметры:
//  Имя          - имя группировки
//  ПутьКДанным  - путь к данным
//  Представление - представление группировки
//  Итог         - Выводить итоги по полю
//
...
// Процедура устанавливает связь полей
// 
// Параметры:
//  ПолеПутьКДанным - поле содержащее путь к данным
//  ПолеРодительПутьКДанным - поле содержащее путь к данным родителя
//
...
// Процедура устанавливает связь поля и измерения
// 
// Параметры:
//  ИмяПоля      - имя поля
//  ИмяИзмерения - имя измерения
...
// функция обработчик события начало выбора поля
//
// Параметры:
//  Расшифровка - расшифровка
//  НачальноеЗначениеВыбора - начальное значение выбора
//  Измерение    - измерения
//  Отбор        - признак использования отбора
//  Поле         - признак что это поле
//  Порядок      - признак что это порядок
//  ДочерниеПоля - разрешить выбор дочерних полей
//
// Возвращаемое значение:
//  выбранное поле
...
//
// Параметры:
//  Элемент      - элемент вызвавший событие
//  Выбор        - выбор
//  ЭлементФормыТабличноеПоле - табличное поле формы
//  СтандартнаяОбработка - выполнять стандартную обработку
//
...
// процедура обработчик события обработка расшифровки универсального отчета
// 
// Параметры:
//  Расшифровка  - расшифровка
//  Отчет        - объект отчет
...
// Процедура выполняет установку периода с заданными параметрами
// 
// Параметры:
//  ДатаНач      - начало периода
//  ДатаКон      - окончание периода
//  Периодичность - периодичность
//  КоличествоПериодов - количество периодов
//
...
// Функция выполняет восстановление настроек отчета
//
// Параметры:
//  Объект       - объект отчета
//  Отчет        - отчет
//  Форма        - форма
...
// Процедура выполняет восстановление настроек отчета
//
// Параметры:
//  Объект       - объект отчета
//  Отчет        - отчет
...
// Процедура выполняет формирование структуры для сохранения настроек
//
// Параметры:
//  СтруктураСНастройками - структура для хранения настроек
//
...
// Выполняет восстановление настроек из структуры
//
// Параметры:
//  СтруктураСНастройками - структура с настройками
//  Отчет        - отчет для которого производится восстановление настроек 
//
// Возвращаемое значение:
...
// Выполняет восстановление дополнительных настроек
//
// Параметры:
//  Объект       - объект
//  Отчет        - отчет в котором производится восстановление настроек
//  ИмяОбъекта   - имя объекта
//
...
// Выполняет сохранение дополнительных настроек
//
// Параметры:
//  Объект       - объект
//  Отчет        - отчет в котором производится восстановление настроек
...
// Выполняет восстановление параметров печати
//
// Параметры:
//  Объект       - объект
//  Отчет        - отчет в котором производится восстановление настроек
//  Форма        - форма в которой настраивается видимость элементов
//  СтруктураСНастройками - структура с устанавливаемыми настройками
//
...
// Выполняет сохранение параметров печати
//
// Параметры:
//  Объект       - объект
//  Отчет        - отчет в котором производится восстановление настроек
...
// Настраивает отображение элементов формы
//
// Параметры:
//  Объект       - объект
//  Форма        - форма в которой настраивается видимость элементов
//  КнопкаИмя    - имя кнопки
//
...
// Добавляет на форму отчета панель быстрых отборов
//
// Параметры:
//  Объект       - отчет объект
//  Форма        - форма в которую добавляется быстрый отбор
//
...
// Добавляет на форму отчета панель дополнительных элементов формы
//
// Параметры:
//  Форма        - форма в которую добавляется быстрый отбор
//  СоставПанелиДополнительныхЭлементовФормы - перечень добавляемых элементов
//
...
// Добавляет на форму отчета кнопки справки
//
// Параметры:
//  Объект       - отчет объект
//  Форма        - форма в которую добавляется кнопки печати
//
...
// Добавляет на форму отчета кнопки печати
//
// Параметры:
//  Объект       - отчет объект
//  Форма        - форма в которую добавляется кнопки печати
...
// управляет видимостью панели быстрые отборы
//
// Параметры:
//  Объект       - отчет объект
//  Форма        - форма в которую добавляется кнопки печати
...
// Инициализирует поля ввода значения
//
// Параметры:
//  Элемент      - Элемент в котором инициализируются значения
//  Форма        - форма в которую добавляется кнопки печати
//
...
// Процедура обработчик события при изменении вида сравнения
//
// Параметры:
//  Элемент      - элемент вызвавший событие
//  Форма        - форма
...
// Параметры:
//  Объект       - объект отчет
//  ПолеТабличногоДокументаРезультат - поле для вывода результата
//
...
// Управляет видимостью кнопки справки
//
// Параметры:
//  Объект       - отчет объект
//  Форма        - форма 
...
// Процедура обработчик события ПриОткрытии формы отчета
// 
// Параметры:
//  Объект       - объект
//  Отчет        - отчет
//  Форма        - открываемая форма
//  СоставПанелиДополнительныхЭлементовФормы - структура описание состава панели дополнительных элементов формы
//  ИмяОбъекта   - имя объекта
Процедура ФормаПриОткрытии(Объект, Отчет, Форма, СоставПанелиДополнительныхЭлементовФормы = Неопределено, ИмяОбъекта = Неопределено) Экспорт
	...
	Если Объект.мВосстанавливатьНастройкиПриОткрытии Тогда
		...
		Если ЗначениеЗаполнено(глЗначениеПеременной("глТекущийПользователь")) И Не ЗначениеЗаполнено(Объект.ДатаНач) И НЕ Объект.мРежимВводаПериода = 1 Тогда
...
// Процедура обработчик события ПриЗакрытии формы отчета
// 
// Параметры:
//  Объект       - объект
//  Отчет        - отчет
...
// выполняет открытие формы настройки и начальную инициализация
// необходимых значения
//
// Параметры:
//  Объект       - объект
//  Отчет        - отчет
//  Форма        - открываемая форма
//  ПолеТабличногоДокументаРезультат - табличное поле для результата
//
...
// Процедура выполняет открытие формы нового отчета 
// 
// Параметры:
//  Объект       - объект
//  Отчет        - отчет
...
// Процедура выполняет установку заголовка для формы отчета
//
// Параметры:
//  Объект       - объект
//  Отчет        - отчет
...
// Процедура выполняет настройку периода отчета
// 
// Параметры:
//  Объект       - отчет объект
//
...
// Процедура выполняет уменьшение периода отчета
//
// Параметры:
//  Объект       - отчет объект
//
...
// Процедура выполняет увеличение периода отчета
//
// Параметры:
//  Объект       - отчет объект
//
...
// Процедура обработчик события нажатия кнопки "Печать"
//
// Параметры:
//  Объект       - отчет объект
//  Отчет        - отчет
...
мМинимальнаяШиринаКолонкиПоказатель = 5;
мШиринаКолонкиПоказательПоУмолчанию = 12;
