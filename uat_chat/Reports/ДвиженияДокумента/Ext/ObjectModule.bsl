...
// Функция определяет можно ли получить отчет по документу
//
...
// Процедура формирует результат отчета в виде табличного документа
//
//Параметры:
//	ДокументРезультат - табличный документ, в который выводятся данные отчета
//
