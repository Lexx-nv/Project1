...
Перем мИскомыйОбъектПоискаДублей Экспорт; // Временная переменная. Искомый объект поиска. 
Перем мСтруктураПоиска Экспорт; // Временная переменная. Структура поиска элементов.
...
// Функция анализирует различия в двух списках слов.
//
//Параметры:
//	Список1, 2 - Списки слов сравнения.
//	ПолныйСписок - Полный список слов.
//	ДопустимоеРазличиеСлов - Количество допустимых символов различия.
//
//Возвращаемое значение:
//	Истина, если слова отличаются.
//
...
КонецФункции // АнализРазличийВСловах()

// Функция анализирует различия в двух списках слов для списков с одинаковым количеством слов.
//
//Параметры:
//	Список1, 2 - Списки слов сравнения.
//	ДопустимоеРазличиеСлов - Количество допустимых символов различия.
...
КонецФункции // ПроверитьСловаНаОтличие()

// Функция получает список слов из строки.
//Разделителями слов считаются не буквенные символы.
//
//Параметры:
//	ЗначениеРеквизита - строка со словами.
//                     
//Возвращаемое значение:
//	Список слов
//
...
КонецФункции // ПолучитьСписокСлов()

// Функция ищет дубли элементов.
//
//Параметры:
//	ИскомыйОбъект - ссылка на искомый объект.
//	СтруктураПоиска - структура реквизитов поиска дублей элементов.
//                     
//Возвращаемое значение:
//	Список слов.
//
