...
//Процедура формирует имена ролей (значений и представлений для вывода пользователю)
...
//  ЭлементОтбора - Массив, массив параметров и значений отбора
//
// Возвращаемые значения
//  НЕТ
...
Процедура ИнициализироватьРаботуСПользователямиИБ() Экспорт
...
// Процедура вызывается при выводе строки в справочнике Пользователи
//Параметры:
//	Соответствуют набору параметров стандартного обработчика ПриВыводеСтроки()
//
...
// Функция возвращает соответствие имя и пользователей ИБ
